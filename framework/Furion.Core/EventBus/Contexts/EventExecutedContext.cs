...
/// 事件处理程序执行后上下文
/// </summary>
public sealed class EventExecutedContext : EventExecutionContext
{
    /// <summary>
    /// 构造函数
    /// </summary>
    ...
    internal EventExecutedContext(IEventSource eventSource, IDictionary<object, object> properties)
