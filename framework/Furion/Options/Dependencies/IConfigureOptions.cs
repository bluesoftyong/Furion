...
public interface IConfigureOptions<TOptions> : IOptionsBuilder
...
public interface IConfigureOptions<TOptions, TDep> : IOptionsBuilder
    where TOptions : class
    where TDep : class
{
    /// <summary>
...
public interface IConfigureOptions<TOptions, TDep1, TDep2> : IOptionsBuilder
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
{
...
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3> : IOptionsBuilder
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
...
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3, TDep4> : IOptionsBuilder
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
...
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5> : IOptionsBuilder
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
