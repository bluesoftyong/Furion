...
public interface IConfigureOptions<TOptions> : IOptionsBuilder<TOptions>
...
[OptionsBuilderMethodMap(nameof(OptionsBuilder<TOptions>.Configure))]
public interface IConfigureOptions<TOptions, TDep> : IOptionsBuilder<TOptions>
    where TOptions : class
    where TDep : class
{
    /// <summary>
...
[OptionsBuilderMethodMap(nameof(OptionsBuilder<TOptions>.Configure))]
public interface IConfigureOptions<TOptions, TDep1, TDep2> : IOptionsBuilder<TOptions>
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
{
...
[OptionsBuilderMethodMap(nameof(OptionsBuilder<TOptions>.Configure))]
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3> : IOptionsBuilder<TOptions>
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
...
[OptionsBuilderMethodMap(nameof(OptionsBuilder<TOptions>.Configure))]
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3, TDep4> : IOptionsBuilder<TOptions>
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
...
[OptionsBuilderMethodMap(nameof(OptionsBuilder<TOptions>.Configure))]
public interface IConfigureOptions<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5> : IOptionsBuilder<TOptions>
    where TOptions : class
    where TDep1 : class
    where TDep2 : class
    where TDep3 : class
